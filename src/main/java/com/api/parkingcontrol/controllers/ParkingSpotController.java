...
//        TODO: Criar um Custom Validation para essas validações
        ...
        BeanUtils.copyProperties(parkingSpotDto, parkingSportModel); // converte DTO em Model
    ...
    @GetMapping
    public ResponseEntity<List<ParkingSportModel>> getAllParkingSpots() {
